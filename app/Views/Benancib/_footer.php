    ...
    <!-- Javascript -->          
    <script src="/book/assets/plugins/popper.min.js"></script>
    <script src="/book/assets/plugins/bootstrap/js/bootstrap.min.js"></script> 
    <script src="/book/assets/plugins/smoothscroll.min.js"></script> 
