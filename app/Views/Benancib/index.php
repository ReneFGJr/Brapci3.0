                ...
                <div class="logo-wrapper">
	                <div class="site-logo">
						<a class="navbar-brand" href="index.html">
							<img class="logo-icon me-2" src="/book/assets/images/site-logo.svg" alt="logo" >
							<span class="logo-text">BRAPCI Livros</span></a></div>    
			    ...
			    <div class="col-12 col-md-7 pt-5 mb-5 align-self-center">
				    <div class="promo pe-md-3 pe-lg-5">
						<div class="mb-3">
							...
							<span class="h2"><?php echo $subtitle;?></span>
						</div>
					><!--//headline-->
						    ...
						    <div id="quotes-carousel" class="quotes-carousel carousel slide carousel-fade mb-5" data-bs-ride="carousel" data-bs-interval="8000">
							    ...
							    <div class="carousel-inner">
								    <div class="carousel-item active">
								        ...
								        <div class="source row gx-md-3 gy-3 gy-md-0 align-items-center">
									        <div class="col-12 col-md-auto text-center text-md-start">
									            <img class="source-profile" src="/book/assets/images/profiles/profile-1.png" alt="image" >
									        </div><!--//col-->
								    ...
								    <div class="carousel-item">
								        ...
								        <div class="source row gx-md-3 gy-3 gy-md-0 align-items-center">
									        <div class="col-12 col-md-auto text-center text-md-start">
									            <img class="source-profile" src="/book/assets/images/profiles/profile-2.png" alt="image" >
									        </div><!--//col-->
									        <div class="col source-info text-center text-md-start">
								    ...
								    <div class="carousel-item">
								        ...
								        <div class="source row gx-md-3 gy-3 gy-md-0 align-items-center">
									        <div class="col-12 col-md-auto text-center text-md-start">
									            <img class="source-profile" src="/book/assets/images/profiles/profile-3.png" alt="image" >
									        </div><!--//col-->
									        <div class="col source-info text-center text-md-start">
			    ...
			    <div class="col-12 col-md-5 mb-5 align-self-center">
				    <div class="book-cover-holder">
					    <img class="img-fluid book-cover" 
							src="/cover/978857/983/9788579839306.png" 
							alt="book cover" >
					    <div class="book-badge d-inline-block shadow">
						    <?php echo lang('book.New').'<br>'.lang('book.Work');?>
					    </div>
				    </div><!--//book-cover-holder-->
				    <div class="text-center"><a class="theme-link scrollto" href="<?php echo PATH.MODULE.'book/reviews-section';?>"><?php echo lang('See_all_book');?></a></div>
			    </div><!--col-->
		    </div><!--//row-->
	    </div><!--//container-->
			    ...
			    <div class="row">
				    <div class="col-12 col-md-6">
					    <div class="figure-holder mb-5">
						    <img class="img-fluid" src="/book/assets/images/devbook-devices.png" alt="image" >
					    </div><!--//figure-holder-->
				    </div><!--//col-->
		    ...
		    <div class="row justify-content-center">
			    ...
			    <div class="item col-12 col-lg-4 p-3 mb-4">
				    <div class="item-inner theme-bg-light rounded p-4">
				        ...
				        <div class="source row gx-md-3 gy-3 gy-md-0 align-items-center">
					        <div class="col-12 col-md-auto text-center text-md-start">
					            <img class="source-profile" src="/book/assets/images/profiles/profile-4.png" alt="image" >
					        </div><!--//col-->
					        <div class="col source-info text-center text-md-start">
			    ...
			    <div class="item col-12 col-lg-4 p-3 mb-4">
				    <div class="item-inner theme-bg-light rounded p-4">
				        ...
				        <div class="source row gx-md-3 gy-3 gy-md-0 align-items-center">
					        <div class="col-12 col-md-auto text-center text-md-start">
					            <img class="source-profile" src="/book/assets/images/profiles/profile-5.png" alt="image" >
					        </div><!--//col-->
					        <div class="col source-info text-center text-md-start">
    ...
    <section id="author-section" class="author-section section theme-bg-primary py-5">
	    <div class="container py-3">
		    <div class="author-profile text-center mb-5">
			    <img class="author-pic" src="/book/assets/images/profiles/author-profile.png" alt="image" >
		    </div><!--//author-profile-->
