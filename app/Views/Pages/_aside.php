...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?php echo base_url(PATH.'res/painel');?>">
        <!-- <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo"> -->
        <span class="ms-1" style="font-family: 'Handel Gothic'; font-size: 1.50em">BRAPCI</span>
        <span class="ms-1" style="font-family: 'Handel Gothic'; font-size: 0.75em">DRASHBOARD</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        foreach($items as $url=>$display)
        {
            echo '
                    <li class="nav-item">
                    <a class="nav-link  " href="'.base_url(PATH.$url).'">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
